...
(function($) {
            ...
            if ($elm.is('option')) {
                ...
                html.push(
                    '<li' + (multiple ? ' class="multiple"' : '') + style + '>',
                            ...
                            '<input type="' + type + '" ' + this.selectItemName + ' id="' + this.onlyName + '_' + value + '"' + 'value="' + value + '"' +
                                (selected ? ' checked="checked"' : '') +
                                (disabled ? ' disabled="disabled"' : '') +
                                (group ? ' data-group="' + group + '"' : '') +
                                '/> ',
                        '<label for="' + this.onlyName + '_' + value + '"' + (disabled ? ' class="disabled"' : '') + '>',
                            text,
                        '</label>',
                    '</li>'
                );
    ...
    $.fn.multipleSelect.defaults = {
        ...
        allSelected: 'Tüm Diller Seçildi',
        minumimCountSelected: 3,
        countSelected: '# dil seçildi',
        multiple: false,
        multipleWidth: 80,
        single: false,
        filter: false,
