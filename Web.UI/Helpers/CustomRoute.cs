...
namespace Web.UI.Helpers {
    public class CustomRoute : Route {
        ...
        public CustomRoute(string url, IRouteHandler routeHandler, string[] namespaces)
            : this(url, null, null, null, routeHandler, null, null, namespaces) {
        }

        public CustomRoute(string url, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext)
            : this(url, null, null, null, routeHandler, area, areaContext, null) {
        }

        public CustomRoute(string url, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext, string[] namespaces)
        ...
        public CustomRoute(string url, RouteValueDictionary defaults, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext)
            : this(url, defaults, null, null, routeHandler, area, areaContext, null) {
        }

        public CustomRoute(string url, RouteValueDictionary defaults, IRouteHandler routeHandler, string[] namespaces)
            : this(url, defaults, null, null, routeHandler, null, null, namespaces) {
        }

        public CustomRoute(string url, RouteValueDictionary defaults, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext, string[] namespaces)
        ...
        public CustomRoute(string url, RouteValueDictionary defaults, RouteValueDictionary constraints, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext)
            : this(url, defaults, constraints, null, routeHandler, area, areaContext, null) {
        }

        public CustomRoute(string url, RouteValueDictionary defaults, RouteValueDictionary constraints, IRouteHandler routeHandler, string[] namespaces)
            : this(url, defaults, constraints, null, routeHandler, null, null, namespaces) {
        }
        public CustomRoute(string url, RouteValueDictionary defaults, RouteValueDictionary constraints, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext, string[] namespaces)
        ...
        public CustomRoute(string url, RouteValueDictionary defaults, RouteValueDictionary constraints, RouteValueDictionary dataTokens, IRouteHandler routeHandler, AreaRegistration area, AreaRegistrationContext areaContext)
            : this(url, defaults, constraints, dataTokens, routeHandler, area, areaContext, null) {
        }

        public CustomRoute(string url, RouteValueDictionary defaults, RouteValueDictionary constraints, RouteValueDictionary dataTokens, IRouteHandler routeHandler, string[] namespaces)
            : this(url, defaults, constraints, dataTokens, routeHandler, null, null, namespaces) {
        }

        public CustomRoute(string url, RouteValueDictionary defaults, RouteValueDictionary constraints,
            ...
            if (area != null) {
                ...
                DataTokens["UseNamespaceFallback"] = ((int)namespaces.Length == 0);
            }
            if (namespaces != null && namespaces.Length > 0) {
